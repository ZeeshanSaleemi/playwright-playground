...
test.describe('Sign Up', () => {
  ...
  test('signup page loads with all form fields', async () => {
  ...
  test('successful signup shows success message and redirects to login', async ({ page }) => {
  ...
  test('submitting empty form shows name required error', async () => {
    await signupPage.submit();
    await signupPage.assertErrorVisible('Full name is required');
  });

  test('missing email shows error', async () => {
